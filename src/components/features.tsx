...
import BlurredShapeGray from "@/components/images/blurred-shape-gray.svg";
import BlurredShape from "@/components/images/blurred-shape.svg";
import FeaturesImage from "@/components/images/features.png";
  ...
  return (
    <section className="relative bg-gray-900 text-gray-200">
      ...
      <div className="mx-auto max-w-6xl px-4 sm:px-6">
        <div className="border-t border-gray-700 py-12 md:py-20">
          {/* Section header */}
          <div className="mx-auto max-w-3xl pb-4 text-center md:pb-12">
            <div className="inline-flex items-center gap-3 pb-3 before:h-px before:w-8 before:bg-gradient-to-r before:from-transparent before:to-indigo-400/50 after:h-px after:w-8 after:bg-gradient-to-l after:from-transparent after:to-indigo-400/50">
              <span className="inline-flex bg-gradient-to-r from-indigo-400 to-indigo-600 bg-clip-text text-transparent">
                Our Services
              </span>
            </div>
            <h2 className="animate-[gradient_6s_linear_infinite] bg-[linear-gradient(to_right,theme(colors.gray.700),theme(colors.indigo.600),theme(colors.gray.800),theme(colors.indigo.700),theme(colors.gray.700))] bg-[length:200%_auto] bg-clip-text pb-4 font-nacelle text-3xl font-semibold text-transparent md:text-4xl">
              We provide assistance for various types of businesses
            </h2>
            <p className="text-lg text-gray-400">
              We provide tailor made services that meet the individual needs of our clients. We have a highly experienced team of consultants that are passionate about their works and rendered services, and are always up for learning. We believe in providing quality services at affordable prices.
            </p>
          </div>
          ...
          <div className="mx-auto grid max-w-sm gap-12 sm:max-w-none sm:grid-cols-2 md:gap-x-14 md:gap-y-16 lg:grid-cols-3">
            <article>
              <svg
                className="mb-3 fill-indigo-400"
